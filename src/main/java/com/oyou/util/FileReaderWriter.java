...
public static List getFileNameList(String dirPath){
	...
	if (file.exists()&&file.isDirectory()) {
		...
		for (File file2 : files) {
			...
			list.add(name);
		//	list.add(name.substring(0,name.lastIndexOf(".")==-1?name.length():name.lastIndexOf(".")));
		}
...
public static void main(String[] args) {
	List list=getFileNameList("F:\\workspace\\tjcgs\\WebRoot\\WEB-INF\\lib");
